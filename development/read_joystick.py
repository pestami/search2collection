...
#===============================================================================
    ...
    def readJoystick(self):
        ...
        setControlerskeywords={'joystick','gamecontroller','gamepad','contoler'}
        
        firstdetectedeventcode=0
        ...
        for device in devices:
            ...
            if setDeviceName  & setControlerskeywords:  # Look for joystick devices
                print(f"Gamepad: {device.name}")
